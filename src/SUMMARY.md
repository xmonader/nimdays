...
- [Day 4: Async LinksChecker](day04_asynclinkschecker.md)
- [Day 5: INI Parser](day05_iniparser.md)
- [Day 6: Nistow (Dotfiles Manager)](day06_nistow.md)
- [Day 7: URL Shortening Service](day07_shorturl.md)
- [Day 8: MiniTest framework](day08_minitest.md)
- [Day 9: TicTacToe CLI](day09_tictactoe_cli.md)
